...
namespace Abp.Timing
{
    ...
    public class ZonedDateTimeRange : DateTimeRange, IZonedDateTimeRange
    {
        ...
        {
            get { return TimezoneHelper.ConvertToDateTimeOffset(StartTime, Timezone); }
        ...
        {
            get { return TimezoneHelper.ConvertToDateTimeOffset(EndTime, Timezone); }
        ...
        {
            get { return StartTimeOffset.UtcDateTime; }
            set
            {
        ...
        {
            get { return EndTimeOffset.UtcDateTime; }
            set
            {
                var localized = TimezoneHelper.ConvertFromUtc(value, Timezone);
                if (localized.HasValue)
